    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <div className="flex justify-center mb-6">
          <div className="w-32 h-32 bg-gradient-to-br from-primary-400 to-primary-600 rounded-3xl flex items-center justify-center shadow-2xl">
      ...
      <Card padding="lg" className="bg-gradient-to-r from-primary-500 to-primary-600">
      ...
      <div className="mt-8 text-center">
        <a
          ...
          className="inline-flex items-center space-x-2 text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300 transition-colors"
        >
          <Send size={20} />
          <span className="font-semibold">Chat via Telegram</span>
        </a>
      </div>
    </div>
  );
